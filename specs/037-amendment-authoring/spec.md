...
summary: >
  ...
  is left alone. Spec 023 amends 004 without editing it; spec 033 amends 005
  ...
  review of PR #89 asked six separate times for spec 030 to be edited to record
...
automated reviewer asked six times for `specs/030-dependency-cycle-refusal/spec.md`
to be edited because spec 035 declared `amends: ["030-dependency-cycle-refusal"]`.
...
```
spec-spine registry relationships 030-dependency-cycle-refusal
  depends_on: 001-compile-registry, 015-short-id-resolution
  amended_by (incoming): 035-registry-plan-ready-set
```
...
prevent. Spec 018's structured partial supersession governs that side.
