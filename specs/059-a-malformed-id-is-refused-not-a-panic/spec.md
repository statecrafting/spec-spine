---
id: "059-a-malformed-id-is-refused-not-a-panic"
...
summary: >
  ...
  code that exists to name exactly that malformation. Spec 046 §4 found the
...
the rule spec 046 already established for `lint.rs::ordinal`, whose doc comment
...
argument spec 046 made for `ordinal` returning `None`.
...
(spec 037). Spec 001 §3.2 requires a numeric prefix check and is unchanged by
