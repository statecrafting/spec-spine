---
id: "047-effective-config-is-a-governed-read"
...
extends:
  ...
  # to what 002 requires. 002's spec.md is not edited (spec 037).
...
summary: >
  ...
  repositories, hand-parses each target's TOML and documents in its spec 015
...
TOML, and its spec 015 D-3 records the conclusion honestly: the built-in floor
...
It MUST NOT be the spec 034 verdict envelope. Spec 034 versions verdicts, and a
...
as it is, and adopter entries stay additive. Spec 008 settled the interaction
...
version-pinning problem, and spec 055 is where it belongs.
...
# claude-observatory recorded as unknowable to it (its spec 015 D-3), and each
...
# 3.3: a query, not a spec 034 verdict envelope.
