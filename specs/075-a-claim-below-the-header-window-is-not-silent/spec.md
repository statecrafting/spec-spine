---
id: "075-a-claim-below-the-header-window-is-not-silent"
...
Spec 029 gave a source file a third way to be claimed: a
...
`plannedTerritory` (spec 063 §3.6) in shape and for the same reason: a corpus
...
Two of those four lines read `# Spec: 094-one-gate-and-the-boundaries-it-holds`, with
...
code.** Spec 029 described the claim without bounding it, so the bound lived
