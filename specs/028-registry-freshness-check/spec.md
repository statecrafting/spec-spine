---
id: "028-registry-freshness-check"
...
summary: >
  ...
  shardHash values with CI green (this is what PR #61 did to specs 016 and 021).
...
spec-spine commits both derived views (spec 022), but only one of them has ever
...
built is by definition not vouching for the corpus. This mirrors spec 011 §3.3,
...
failure messages single-subject, per spec 011 §3.3. Teaching the coupling gate
