---
id: "051-retroactive-adoption-shape"
...
Constitution V gained its operational half in spec 040:
...
The corpus already knows how to answer this, and has since spec 020. Section
...
`defects-heading-anchor`, on the same section spec 040 refined under the aspect
...
```
L-009  spec '028-registry-freshness-check' has heading '## Known defect'
...
The audit's item 10 proposed one, and spec 040 already answered it in the
