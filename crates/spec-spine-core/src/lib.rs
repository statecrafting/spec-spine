...
pub use index::{
    ...
    check_slice_freshness, guard_committed_index, index, index_dir, index_freshness_report,
    index_inputs_file, index_shard_files, load_committed_index, owner, owner_with, slices_path,
    unwitnessed_claims, witnessed_paths,
};
pub use interface::{
