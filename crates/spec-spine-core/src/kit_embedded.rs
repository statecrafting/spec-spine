...
"#),
    (r#".claude/skills/cleanup/SKILL.md"#, r#"---
name: cleanup
...
$ARGUMENTS
"#),
    (r#".claude/skills/implement-plan/SKILL.md"#, r#"---
name: implement-plan
...
`$ARGUMENTS`
"#),
    (r#".claude/skills/research/SKILL.md"#, r#"---
name: research
...
"#),
    (r#".claude/skills/validate-and-fix/SKILL.md"#, r#"---
...
"#),
    (r#"scripts/verify-spec.sh"#, r#"#!/usr/bin/env bash
