...
echo "  registry:  $(git check-attr merge .statecraft/derived/spec-registry/by-spec/000-x.json)"
echo "  index:     $(git check-attr merge .statecraft/derived/codebase-index/by-spec/000-x.json)"
