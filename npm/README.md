...
**The [`spec-spine`](https://github.com/statecrafting/spec-spine) CLI, distributed as a
...
Apache-2.0. See the [repository](https://github.com/statecrafting/spec-spine) for full
